...
let MB = 1
let GB = 1000 * MB
let iPhoneCapacity = 8 * GB
let spaceFilled = 3 * GB
let freeSpace = iPhoneCapacity - spaceFilled
let minuteOfVideoSpace = 150 * MB
let tellUser = "You can record \(freeSpace / minuteOfVideoSpace) more minutes of video"
